...
import { CalendarToday, MeetingRoom, Group } from '@mui/icons-material'; // นำเข้าไอคอนจาก MUI
  ...
  return (
    <div id="ระบบของเรา" className="bg-gray-100 py-10">
      ...
      {/* <p className="text-center text-gray-600 mb-8">
        Our top system recommendation provides advanced features and reliable performance, tailored to enhance your efficiency.
      </p> */}
      ...
      <div className="flex justify-center space-x-4">
        ...
        <div className="w-48 h-48 bg-white rounded-lg shadow-lg flex flex-col items-center justify-center transition-transform transform hover:scale-105 duration-300">
          <div className="bg-gray-200 w-24 h-24 rounded-full mb-4 flex items-center justify-center">
            <CalendarToday style={{ fontSize: 48, color: 'gray' }} /> {/* โลโก้ปฏิทินจาก MUI */}
          </div>
          <button
        ...
        <div className="w-48 h-48 bg-white rounded-lg shadow-lg flex flex-col items-center justify-center transition-transform transform hover:scale-105 duration-300">
          <div className="bg-gray-200 w-24 h-24 rounded-full mb-4 flex items-center justify-center">
            <MeetingRoom style={{ fontSize: 48, color: 'gray' }} /> {/* โลโก้การจองห้องจาก MUI */}
          </div>
          <button
            className="px-4 py-2 bg-blue-500 text-white rounded-lg shadow-md transition-colors hover:bg-blue-600 duration-300 focus:outline-none"
            onClick={() => alert('การจองห้อง system selected!')}
          >
            การจองห้อง
          </button>
        </div>
        ...
        <div className="w-48 h-48 bg-white rounded-lg shadow-lg flex flex-col items-center justify-center transition-transform transform hover:scale-105 duration-300">
          <div className="bg-gray-200 w-24 h-24 rounded-full mb-4 flex items-center justify-center">
            <Group style={{ fontSize: 48, color: 'gray' }} /> {/* โลโก้สมาชิกจาก MUI */}
          </div>
          <button
            className="px-4 py-2 bg-blue-500 text-white rounded-lg shadow-md transition-colors hover:bg-blue-600 duration-300 focus:outline-none"
